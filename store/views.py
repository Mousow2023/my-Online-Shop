...
def submit_review(request, product_id):
    ...
    if request.method == "POST":
        try:
            ...
            form.save()
            messages.success(request, "Thank you for your feedback. Your review has been updated!")
            ...
            if form.is_valid():
                ...
                data.save()
                messages.success(request, "Thank you for your feedback. Your review has been saved!")
